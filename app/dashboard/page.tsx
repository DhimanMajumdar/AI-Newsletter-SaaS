...
export default function DashboardPage() {
  ...
  const handleUpdatePreferences = () => router.push("/select");
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 text-sm sm:text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-colors"
              >
                <svg
                ...
                <>
                  {preferences.is_active ? (
                    <button
                      ...
                      className="w-full flex items-center justify-center px-4 py-3 text-sm sm:text-base font-medium rounded-md text-red-700 bg-red-50 border border-red-300 hover:bg-red-100 transition-colors"
                    >
                      <svg
                        className="w-5 h-5 sm:w-6 sm:h-6 mr-2"
                        fill="none"
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center px-4 py-3 text-sm sm:text-base font-medium rounded-md text-green-700 bg-green-50 border border-green-300 hover:bg-green-100 transition-colors"
                    >
                      <svg
                        className="w-5 h-5 sm:w-6 sm:h-6 mr-2"
                        fill="none"
        ...
        <div className="mt-8 bg-blue-50 rounded-lg p-6">
          ...
          <ul className="text-blue-800 space-y-1 text-sm sm:text-base list-disc list-inside">
            <li>
